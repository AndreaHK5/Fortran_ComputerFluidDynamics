...
c      open (14,file = 'met',  form = 'unformatted')
c      open (21,file='usrckmetric')
c      open (33,file='usrcell')
...
c ---------------------
      ...
      call ginomkr
      print *,'Hey buddy, pay attention cuz this is'
      print *,' Ginogrid! (for', lg,' block(s))'
      print *,''

c ----------------------
c output di tutta la cella su file usrcell
c  comentato xche di una pesantezza unica (105 Mb..)
c sostituito dall'outpot delle divisioni dei semi assi
c   in ginomkr su file usrsegm
c -----------------------------------
c      do 1 ill=1,lg
c      do 1 i=1,iv(ill)
c      do 1 j=1,jv(ill)
c      do 1 k=1,kv(ill)
c        write(33,*),i,j,k
c	write(33,*)(x2(ill,i,j,k,l),l=1,3)
c1     continue
...
c
c
c      write(14)(((jac(i,j,k), i = 1,ncx), j = 1,ncy),
c     &          k = 1,ncz)
c      write(14)(((xix(i,j,k), i = 1,ncx), j = 1,ncy),
c     &          k = 1,ncz)
c      write(14)(((xiy(i,j,k), i = 1,ncx), j = 1,ncy),
c     &          k = 1,ncz)
c      write(14)(((xiz(i,j,k), i = 1,ncx), j = 1,ncy),
c     &          k = 1,ncz)
c      write(14)(((etx(i,j,k), i = 1,ncx), j = 1,ncy),
c     &          k = 1,ncz)
c      write(14)(((ety(i,j,k), i = 1,ncx), j = 1,ncy),
c     &          k = 1,ncz)
c      write(14)(((etz(i,j,k), i = 1,ncx), j = 1,ncy),
c     &          k = 1,ncz)
c      write(14)(((ztx(i,j,k), i = 1,ncx), j = 1,ncy),
c     &          k = 1,ncz)
c      write(14)(((zty(i,j,k), i = 1,ncx), j = 1,ncy),
c     &          k = 1,ncz)
c      write(14)(((ztz(i,j,k), i = 1,ncx), j = 1,ncy),
c     &          k = 1,ncz)
