...
c sapientemente comentata xche nn serviva, se serve scommentala
c ----------------

c      write(21,294)
c      write(21,*)'MAX',ajacm,imjac,jmjac,kmjac
c
c      write(21,295)g12m,i12,j12,k12
c      write(21,296)g13m,i13,j13,k13
c      write(21,297)g23m,i23,j23,k23
c 294  format('Check the orthogonality of the grid',/)
c
c 295  format(1x,'g12max = ',e10.4,' i = ',i3,
c     &' j = ',i3,' k = ',i3,/)
c 296  format(1x,'g13max = ',e10.4,' i = ',i3,
c     &' j = ',i3,' k = ',i3,/)
c 297  format(1x,'g23max = ',e10.4,' i = ',i3,
c     &' j = ',i3,' k = ',i3,/)
